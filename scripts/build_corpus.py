...
.codebook tbody tr:nth-child(even) {
  background: #fafbfc;
}

.codebook tr:last-child td {
  border-bottom: 0;
}

.codebook th:first-child,
.codebook td:first-child {
  width: 19%;
}

.codebook th:nth-child(2),
.codebook td:nth-child(2) {
  width: 56%;
}

.codebook th:last-child,
.codebook td:last-child {
  width: 25%;
}
